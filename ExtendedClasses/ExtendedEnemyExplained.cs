...
public class ExtendedEnemyExplained {
    ...
    public string runsPlayed = "The group can always spawn (levelsCompleted conditions are ignored!) as long as the host player's total sum of runs played is larger than this number";
    public string[] spawnObjects = ["The name of an enemy that should be spawned when this group is picked", "Another one", "You can put as many as you want", "See the mod's description for a list of enemy names"];
